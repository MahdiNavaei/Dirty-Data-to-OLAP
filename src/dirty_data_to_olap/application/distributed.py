...
class ScaleService(PartitionExecutorPort):
    ...
    def equivalence_report(self, dataset: ScaleInputDataset, *, local_reference_execution_id: str, local_reference_output: ScaleMergedOutput, partitioned_execution: ScaleExecutionResult, plan: Any, failure_test_evidence: dict[str, bool] | None = None, materialization_equivalence: bool | None = None, verified_content_commit: str = "0" * 40) -> ScaleEquivalenceReport:

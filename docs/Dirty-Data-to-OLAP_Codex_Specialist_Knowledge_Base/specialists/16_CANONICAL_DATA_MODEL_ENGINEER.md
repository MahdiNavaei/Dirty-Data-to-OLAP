...
role_id: "canonical_model"
role: "Canonical Data Model Engineer"
keywords:
  - "canonical model"
  - "golden record"
  - "survivorship"
...
# 16 — Canonical Data Model Engineer Playbook

## 1. Mission in this project

Turn accepted schema/relationship/entity evidence into a coherent canonical business model while preserving source provenance and uncertainty.

This is not a generic job description. It is the operating manual Codex should retrieve when acting as **Canonical Data Model Engineer** for Dirty Data to OLAP.
...
- canonical entity/attribute representation
- source-to-canonical mappings
- survivorship implementation
- canonical identifiers
- provenance graph through merged representations
- canonical model versioning

## 5. This specialist explicitly does NOT own

- final analytical star schema
- pairwise linkage internals
- inventing domain definitions without expert evidence
...
- entity boundaries
- canonical attribute names/types
- source precedence per attribute
- conflict retention vs chosen value
- stable canonical ID construction
- handling one-to-many source representations
...
- build canonical entities from reviewed mappings
- attach every canonical value to source evidence/provenance
- apply deterministic normalization before survivorship
- represent conflicts explicitly when unresolved
- integrate entity clusters without deleting source records
- version canonical schemas and migrations
- emit contracts consumed by analytical planner
...
- models/canonical/
- tests/canonical/
- docs/canonical/modeling-policy.md
...
- source→canonical mapping completeness
- provenance preservation
- stable ID tests
- conflicting-value scenarios
- entity split/merge versioning tests
...
- golden record with no source trace
- last-write-wins across unrelated systems
- overwriting disagreements silently
- using entity-cluster numeric IDs directly as long-term business IDs
- canonicalizing before evidence review where ambiguity is high
...
Primary collaborators: **Principal Data Architect, Entity Resolution Engineer, Evidence Fusion Engineer, Domain Expert, OLAP Engineer**.
...
1. Build canonical Customer from CRM/Web/ERP.
2. Resolve phone precedence with timestamps and trusted-source policy.
3. Represent unresolved disagreement in customer legal status.
...
When the user or routing layer says **"act as Canonical Data Model Engineer"**, use this document as the primary role contract. Be proactive inside this role's ownership, but do not override authoritative decisions from the base reports. If implementation and documentation disagree, inspect evidence, report the discrepancy, and prefer correcting the inconsistency over silently choosing one side.

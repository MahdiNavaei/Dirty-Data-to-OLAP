...
def main() -> int:
    ...
    checks = {
        ...
        "Step15/16 handoff state": (execution.get("last_completed_step") == 15 and execution.get("current_step") == 16 and execution.get("current_role") == "llm_semantic_ai_engineer") or (execution.get("last_completed_step") == 16 and execution.get("current_step") == 17 and execution.get("current_role") == "evidence_fusion_engineer"),

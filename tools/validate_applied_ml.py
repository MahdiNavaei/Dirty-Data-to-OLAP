...
def main() -> int:
    ...
    checks = {
        ...
        "Step15 handed to Step16": execution.get("last_completed_step") == 15 and execution.get("current_step") == 16 and execution.get("current_role") == "llm_semantic_ai_engineer" and execution.get("blocked") is not True,
        "G4 remains pending and G4A remains pass": state.get("gates", {}).get("G4_BOUNDED_INTELLIGENCE") == "PENDING" and state.get("intermediate_milestones", {}).get("G4A_INDEPENDENT_EVIDENCE_PRODUCERS") == "PASS",

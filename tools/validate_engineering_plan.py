...
CRITICAL_TOPOLOGY = {
    ...
    "FactSpec": ("application.analytical_planner", "ANALYTICAL_PLANNING"),
    "DimensionSpec": ("application.analytical_planner", "ANALYTICAL_PLANNING"),
    "GrainSpec": ("application.analytical_planner", "ANALYTICAL_PLANNING"),
    "MeasureSpec": ("application.analytical_planner", "ANALYTICAL_PLANNING"),
...
def main() -> int:
    ...
    step34_pass = step34_observability_closed(state)
    step35_pass = step35_sre_closed(state)
    ...
    if mode == "pre" and execution.get("current_step", 0) < 6:
        ...
        check(
            ...
            or (execution.get("current_step") == 25 and execution.get("current_role") == "ux_product_designer" and execution.get("last_completed_step") == 24 and execution.get("last_completed_role") == "distributed_data_engineer" and gates.get("G3_SOURCE_SAFETY") == "PASS" and gates.get("G6_DATA_CORRECTNESS") == "PASS")
            or (execution.get("current_step") == 26 and execution.get("current_role") == "data_visualization_engineer" and execution.get("last_completed_step") == 25 and execution.get("last_completed_role") == "ux_designer" and gates.get("G3_SOURCE_SAFETY") == "PASS" and gates.get("G6_DATA_CORRECTNESS") == "PASS")
            or (execution.get("current_step") == 27 and execution.get("current_role") == "senior_backend_engineer" and execution.get("last_completed_step") == 26 and execution.get("last_completed_role") == "data_visualization_engineer" and gates.get("G3_SOURCE_SAFETY") == "PASS" and gates.get("G6_DATA_CORRECTNESS") == "PASS")
            or (execution.get("current_step") == 28 and execution.get("current_role") == "distributed_job_processing_engineer" and execution.get("last_completed_step") == 27 and execution.get("last_completed_role") == "senior_backend_engineer" and gates.get("G3_SOURCE_SAFETY") == "PASS" and gates.get("G6_DATA_CORRECTNESS") == "PASS")
            or (execution.get("current_step") == 29 and execution.get("current_role") == "frontend_engineer" and execution.get("last_completed_step") == 28 and execution.get("last_completed_role") == "distributed_job_processing_engineer" and gates.get("G3_SOURCE_SAFETY") == "PASS" and gates.get("G6_DATA_CORRECTNESS") == "PASS")
            or (execution.get("current_step") == 31 and execution.get("current_role") == "qa_automation_engineer" and execution.get("last_completed_step") == 30 and execution.get("last_completed_role") == "devops_engineer" and gates.get("G3_SOURCE_SAFETY") == "PASS" and gates.get("G6_DATA_CORRECTNESS") == "PASS" and gates.get("G8_REPRODUCIBLE_BUILD") == "PASS")
            or (execution.get("current_step") == 32 and execution.get("current_role") == "compatibility_test_engineer" and execution.get("last_completed_step") == 31 and execution.get("last_completed_role") == "qa_automation_engineer" and gates.get("G3_SOURCE_SAFETY") == "PASS" and gates.get("G6_DATA_CORRECTNESS") == "PASS" and gates.get("G8_REPRODUCIBLE_BUILD") == "PASS" and step31_qa_closed(state))
            or (execution.get("current_step") == 33 and execution.get("current_role") == "application_security_engineer" and execution.get("last_completed_step") == 32 and execution.get("last_completed_role") == "compatibility_test_engineer" and gates.get("G3_SOURCE_SAFETY") == "PASS" and gates.get("G6_DATA_CORRECTNESS") == "PASS" and gates.get("G8_REPRODUCIBLE_BUILD") == "PASS" and gates.get("G9_FUNCTIONAL_SUPPORT") == "PASS" and step32_pass)
            or (execution.get("current_step") == 34 and execution.get("current_role") == "observability_engineer" and execution.get("last_completed_step") == 33 and execution.get("last_completed_role") == "application_security_engineer" and gates.get("G3_SOURCE_SAFETY") == "PASS" and gates.get("G6_DATA_CORRECTNESS") == "PASS" and gates.get("G8_REPRODUCIBLE_BUILD") == "PASS" and gates.get("G9_FUNCTIONAL_SUPPORT") == "PASS" and gates.get("G10_APPLICATION_SECURITY") == "PASS" and step33_pass)
            or (execution.get("current_step") == 35 and execution.get("current_role") == "sre" and execution.get("last_completed_step") == 34 and execution.get("last_completed_role") == "observability_engineer" and gates.get("G3_SOURCE_SAFETY") == "PASS" and gates.get("G6_DATA_CORRECTNESS") == "PASS" and gates.get("G8_REPRODUCIBLE_BUILD") == "PASS" and gates.get("G9_FUNCTIONAL_SUPPORT") == "PASS" and gates.get("G10_APPLICATION_SECURITY") == "PASS" and step34_pass)
            or (execution.get("current_step") == 36 and execution.get("current_role") == "chaos_resilience" and execution.get("last_completed_step") == 35 and execution.get("last_completed_role") == "sre" and gates.get("G3_SOURCE_SAFETY") == "PASS" and gates.get("G6_DATA_CORRECTNESS") == "PASS" and gates.get("G8_REPRODUCIBLE_BUILD") == "PASS" and gates.get("G9_FUNCTIONAL_SUPPORT") == "PASS" and gates.get("G10_APPLICATION_SECURITY") == "PASS" and step35_pass)
            or (execution.get("current_step") == 37 and execution.get("current_role") == "performance_engineer" and execution.get("last_completed_step") == 36 and execution.get("last_completed_role") == "chaos_resilience" and gates.get("G3_SOURCE_SAFETY") == "PASS" and gates.get("G6_DATA_CORRECTNESS") == "PASS" and gates.get("G8_REPRODUCIBLE_BUILD") == "PASS" and gates.get("G9_FUNCTIONAL_SUPPORT") == "PASS" and gates.get("G10_APPLICATION_SECURITY") == "PASS" and gates.get("G11_RESILIENCE") == "PASS" and step36_pass)
            or (execution.get("current_step") == 38 and execution.get("current_role") == "load_stress" and execution.get("last_completed_step") == 37 and execution.get("last_completed_role") == "performance_engineer" and gates.get("G3_SOURCE_SAFETY") == "PASS" and gates.get("G6_DATA_CORRECTNESS") == "PASS" and gates.get("G8_REPRODUCIBLE_BUILD") == "PASS" and gates.get("G9_FUNCTIONAL_SUPPORT") == "PASS" and gates.get("G10_APPLICATION_SECURITY") == "PASS" and gates.get("G11_RESILIENCE") == "PASS" and step37_performance_closed(state))
             or (execution.get("current_step") == 39 and execution.get("current_role") == "penetration_red_team" and execution.get("last_completed_step") == 38 and execution.get("last_completed_role") == "load_stress" and gates.get("G3_SOURCE_SAFETY") == "PASS" and gates.get("G6_DATA_CORRECTNESS") == "PASS" and gates.get("G8_REPRODUCIBLE_BUILD") == "PASS" and gates.get("G9_FUNCTIONAL_SUPPORT") == "PASS" and gates.get("G10_APPLICATION_SECURITY") == "PASS" and gates.get("G11_RESILIENCE") == "PASS" and gates.get("G12_CAPACITY") == "PASS" and step38_pass)
            or (execution.get("current_step") == 40 and execution.get("current_role") == "developer_experience_engineer" and execution.get("last_completed_step") == 39 and execution.get("last_completed_role") == "penetration_red_team" and gates.get("G3_SOURCE_SAFETY") == "PASS" and gates.get("G6_DATA_CORRECTNESS") == "PASS" and gates.get("G8_REPRODUCIBLE_BUILD") == "PASS" and gates.get("G9_FUNCTIONAL_SUPPORT") == "PASS" and gates.get("G10_APPLICATION_SECURITY") == "PASS" and gates.get("G11_RESILIENCE") == "PASS" and gates.get("G12_CAPACITY") == "PASS" and gates.get("G13_ADVERSARIAL_SECURITY") == "PASS" and step39_pass)
            or (execution.get("current_step") == 41 and execution.get("current_role") == "technical_writer" and execution.get("last_completed_step") == 40 and execution.get("last_completed_role") == "developer_experience_engineer" and gates.get("G3_SOURCE_SAFETY") == "PASS" and gates.get("G6_DATA_CORRECTNESS") == "PASS" and gates.get("G8_REPRODUCIBLE_BUILD") == "PASS" and gates.get("G9_FUNCTIONAL_SUPPORT") == "PASS" and gates.get("G10_APPLICATION_SECURITY") == "PASS" and gates.get("G11_RESILIENCE") == "PASS" and gates.get("G12_CAPACITY") == "PASS" and gates.get("G13_ADVERSARIAL_SECURITY") == "PASS" and step40_pass)
        )

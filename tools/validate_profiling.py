...
def main() -> int:
    ...
    try:
        ...
        if execution["current_step"] not in range(8, 36) and not (execution["current_step"] == 36 and step35_sre_closed(state)) and not (execution["current_step"] == 37 and step36_resilience_closed(state)):

...
def build_reference_plan(model: CanonicalModel, binding: AnalyticalInputBinding, fixture: AnalyticalInputFixture, *, created_at: datetime | None = None):
    ...
    fact = FactSpec(
        ...
        dimension_foreign_keys=(
            ...
            FactForeignKeySpec(relationship_ref="rel_orderline_order", dimension_id="dim_date", fact_column="date_key", dimension_key_column="date_key", canonical_entity_type_id="synthetic_date_dimension", input_reference_column="order_date"),
        ),
        ...
        relationship_refs=("rel_order_customer", "rel_orderline_order", "rel_orderline_product", "rel_order_branch"),
        provenance_refs=provenance,
    )

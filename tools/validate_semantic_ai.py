...
def main() -> int:
    ...
    handoff_consistent = (("current_handoff: \"Step16 LLM / Semantic AI Engineer\"" in plan_text and "current_step: 16" in state_text) or ("current_handoff: \"Step17 Evidence Fusion Engineer\"" in plan_text and "current_step: 17" in state_text) or ("current_handoff: \"Step18 ML Evaluation Engineer\"" in plan_text and "current_step: 18" in state_text) or ("current_step: 19" in state_text and "Step19" in (ROOT / "docs/execution/SPECIALIST_EXECUTION_LOG.md").read_text(encoding="utf-8")))

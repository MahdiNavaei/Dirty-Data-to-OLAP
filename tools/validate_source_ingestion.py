...
def main() -> int:
    ...
    gates = state["gates"]
    if not ((specialist["current_step"] == 7 and specialist["last_completed_step"] == 6) or (specialist["current_step"] == 8 and specialist["last_completed_step"] == 7) or (specialist["current_step"] == 9 and specialist["last_completed_step"] == 8) or (specialist["current_step"] == 10 and specialist["last_completed_step"] == 9) or (specialist["current_step"] == 11 and specialist["last_completed_step"] == 10) or (specialist["current_step"] == 12 and specialist["last_completed_step"] == 11)):

...
def main() -> int:
    ...
    checks = {
        ...
        "step14 implementation is present and later handoff is explicit": (ROOT / "src/dirty_data_to_olap/adapters/entity_resolution").exists() and is_authorized_specialist_handoff(state_data, minimum_current_step=15, maximum_current_step=31) and state_data.get("gates", {}).get("G4_BOUNDED_INTELLIGENCE") in {"PENDING", "PASS"},

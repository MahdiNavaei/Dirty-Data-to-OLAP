...
def main() -> int:
    ...
    checks = {
        ...
        "later specialist handoff": ((execution.get("last_completed_step"), execution.get("current_step"), execution.get("current_role")) in {(14, 15, "applied_ml_engineer"), (15, 16, "llm_semantic_ai_engineer"), (16, 17, "evidence_fusion_engineer"), (17, 18, "ml_evaluation_engineer"), (18, 19, "canonical_model_engineer")}) and execution.get("blocked") is not True,

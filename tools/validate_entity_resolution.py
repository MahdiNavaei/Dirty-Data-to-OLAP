...
def main() -> int:
    ...
    checks = {
        ...
        "Step14 handed to Step15": execution.get("last_completed_step") == 14 and execution.get("current_step") == 15 and execution.get("current_role") == "applied_ml_engineer" and execution.get("blocked") is not True,

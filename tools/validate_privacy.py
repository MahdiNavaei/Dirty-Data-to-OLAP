...
def main() -> int:
    ...
    checks.append(("execution remains at Step11 through later specialist handoff", step41_g15_closed(state) or execution.get("current_step") in set(range(11, 36)) or (execution.get("current_step") == 36 and step35_sre_closed(state)) or (execution.get("current_step") == 37 and step36_resilience_closed(state)) or (execution.get("current_step") == 38 and step37_performance_closed(state)) or (execution.get("current_step") == 39 and step38_load_stress_closed(state)) or (execution.get("current_step") == 40 and step39_red_team_closed(state)) or (execution.get("current_step") == 41 and step40_g14_closed(state))))

...
def main() -> int:
    ...
    checks.append(("execution remains at Step11 through the Step16 handoff", (execution.get("current_step") == 11 and execution.get("current_role") == "database_security_specialist") or (execution.get("current_step") == 12 and execution.get("last_completed_step") == 11 and execution.get("current_role") == "dependency_discovery_engineer") or (execution.get("current_step") == 13 and execution.get("last_completed_step") == 12 and execution.get("current_role") == "schema_matching_engineer") or (execution.get("current_step") == 14 and execution.get("last_completed_step") == 13 and execution.get("current_role") == "entity_resolution_engineer") or (execution.get("current_step") == 15 and execution.get("last_completed_step") == 14 and execution.get("current_role") == "applied_ml_engineer") or (execution.get("current_step") == 16 and execution.get("last_completed_step") == 15 and execution.get("current_role") == "llm_semantic_ai_engineer")))

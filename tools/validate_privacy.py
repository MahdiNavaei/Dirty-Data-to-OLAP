...
def main() -> int:
    ...
    checks.append(("execution remains at Step11, Step12, or the explicit Step13 handoff", (execution.get("current_step") == 11 and execution.get("current_role") == "database_security_specialist") or (execution.get("current_step") == 12 and execution.get("last_completed_step") == 11 and execution.get("current_role") == "dependency_discovery_engineer") or (execution.get("current_step") == 13 and execution.get("last_completed_step") == 12 and execution.get("current_role") == "schema_matching_engineer")))

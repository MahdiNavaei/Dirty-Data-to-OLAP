...
def main() -> int:
    ...
    checks.append(("G4 remains PASS and G5 is pending, review-only validated, or formal PASS", state["gates"]["G4_BOUNDED_INTELLIGENCE"] == "PASS" and state["gates"]["G5_INFERENCE_VALIDITY"] in {"PENDING", "REVIEW_ONLY_VALIDATED", "PASS"}))
